...
I am a University of Exeter Solution Architect
              ...
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="tony Greenfield" src={`https://media.discordapp.net/attachments/737348411568685066/996841172372824184/YT_AVATAR_NET.jpg`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://github.com/swissboy76/`+_.name}
                      target="_blank"
                      rel="noreferrer"
